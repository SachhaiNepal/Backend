# Generated by Django 3.1 on 2020-08-16 09:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='member',
            name='country',
            field=models.CharField(blank=True, choices=[('AFG', 'Afghanistan'), ('IND', 'India'), ('PAK', 'Pakistan'), ('BAN', 'Bangladesh'), ('SRI', 'Sri Lanka'), ('NEP', 'Nepal'), ('BHU', 'Bhutan'), ('MAL', 'Maldives')], max_length=3, null=True),
        ),
        migrations.AddField(
            model_name='member',
            name='district',
