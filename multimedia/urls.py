...
urlpatterns += [
    ...
    path("multimedia/<int:pk>/toggle-approval", views.ToggleMultimediaApprovalView.as_view()),
    path("article/<int:pk>/toggle-approval", views.ToggleArticleApprovalView.as_view()),
    path("multimedia/<int:pk>/toggle-approval", views.ToggleMultimediaApprovalView.as_view()),
